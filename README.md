...
[Automate the download and conversion/extraction of audio and video from the internet](#how-to-download-and-convert-youtube-videos) using **youtube-dl** and **ffmpeg**, and learned a bit of Markdown in the process. Original plan was to use HTML and CSS, but GitHub thought otherwise and the concept of Markdown interests me nonetheless.
